      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          <p>
            ...
            . Finally, this is a <a href="#top">link</a>.
          </p>
          ...
          <ul className="actions">
            ...
            <li>
              <a href="#top" className="button small">
                Small
              </a>
            </li>
          </ul>
          <ul className="actions fit">
            <li>
              <a href="#top" className="button primary fit">
                Fit
              </a>
            </li>
            <li>
              <a href="#top" className="button fit">
                Fit
              </a>
            </li>
          </ul>
          <ul className="actions fit small">
            <li>
              <a href="#top" className="button primary fit small">
                Fit + Small
              </a>
            </li>
            <li>
              <a href="#top" className="button fit small">
                Fit + Small
              </a>
            </li>
          </ul>
